...
if ( ! function_exists( 'toroflix_scripts_admin' ) ) :
/**
 * Enqueue scripts and styles in admin.
 */
function toroflix_scripts_admin($hook) {
...
add_action( 'admin_enqueue_scripts', 'toroflix_scripts_admin' );
...
function tr_admin(){
    ...
    if(isset($_POST['action']) and $_POST['action']=='tr_admin'){
        ...
        if(!empty($_POST['value'])){
            ...
            if(empty($result)){ echo '<li class="trnoresults">'.__('No results found.', 'toroflix').'</li>'; }
        }else{
