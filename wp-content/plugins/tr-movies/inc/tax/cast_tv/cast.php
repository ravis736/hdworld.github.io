...
<section>
    ...
    <div class="AdmCls AltClBx">
        ...
        <aside>
            <?php echo $error.$ok; ?>
            <form action="<?php echo admin_url('admin.php?page=tr-movies-tv&action=cast'); ?>" method="post">
                <div class="TPTblCn TblCnAdm">
                    <?php
                        ...
                        $number = count(get_terms('cast_tv', array( 'hide_empty' => false )));
                        ...
                        $terms = get_terms('cast_tv', $term_args);
                                ...
                                foreach ($terms as $term) {
                                    echo '
                                        <tr>
                                            ...
                                            <td class="td1ln"><a class="edtlnk" href="admin.php?page=tr-movies-tv&action=cast&edit='.$term->term_id.'"><i class="dashicons dashicons-edit"></i>'.__('Edit', TRMOVIES).'</a><a onclick="return confirm(\''.__('Are you sure?', TRMOVIES).'\');" class="dltlnk" href="admin.php?page=tr-movies-tv&action=cast&del='.$term->term_id.'"><i class="dashicons dashicons-trash"></i>'.__('Delete', TRMOVIES).'</a></td>
                                        </tr>
                                    ';
                                }                  
                            ?>
